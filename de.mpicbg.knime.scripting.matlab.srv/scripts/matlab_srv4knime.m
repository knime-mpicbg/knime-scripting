function mServer = matlab_srv4knime(varargin)
% STARTSERVER
%
...
allLibs = getjarfiles(parser.Results.rootDirectory);
...
mServer = de.mpicbg.knime.scripting.matlab.srv.MatlabWebServer();
