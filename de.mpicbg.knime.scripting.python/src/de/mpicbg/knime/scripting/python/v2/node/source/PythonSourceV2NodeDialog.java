...
/**
 * <code>NodeDialog</code> for the "Python Source" Node.
 *
 * Antje Janosch (MPI-CBG)
 */
public class PythonSourceV2NodeDialog extends ScriptingNodeDialog {
	 ...
	 */
	public PythonSourceV2NodeDialog(String defaultScript, ScriptingModelConfig smc) {
     ...
     * @param useOpenIn
     */
    public PythonSourceV2NodeDialog(String defaultScript, 
